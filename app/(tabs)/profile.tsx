...
import {isMockMode, supabase} from "@/config/api";
...
export default function ProfileScreen() {
  ...
  return (
    <ScrollView style={s.container} contentContainerStyle={s.content}>
      ...
      <Pressable style={s.portalBtn} onPress={() => router.push("/portal")}>
        <Text style={s.portalText}>Open Web Portal</Text>
      </Pressable>
...
const s = StyleSheet.create({
  ...
  portalBtn: { paddingVertical: 14, borderRadius: 12, borderWidth: 1, borderColor: `${theme.colors.info}44`, alignItems: "center", marginBottom: 24, backgroundColor: `${theme.colors.info}10` },
  portalText: { fontSize: 13, fontWeight: "600", color: theme.colors.info },
